...
COLOR_PRIMARY = "MidnightBlue"
COLOR_SECONDARY = "Blue4"
...
class PomodoroTimer(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        style.configure("TimerText.TLabel", background=COLOR_LIGHT_BACKGROUND, foreground=COLOR_DARK_TEXT,
                        font="Courier 38")

        style.configure("LightText.TLabel", background=COLOR_PRIMARY, foreground=COLOR_LIGHT_TEXT)
