...
class Timer(ttk.Frame):
    def __init__(self, parent, controller, show_settings):
        ...
        settings_button = ttk.Button(self, text="Settings", command=show_settings, style="PomodoroButton.TButton",
                                     cursor="hand2")
        ...
        self.stop_button = ttk.Button(button_container, text="Stop", state="disabled", command=self.stop_timer,
                                      cursor="hand2", style="PomodoroButton.TButton")
